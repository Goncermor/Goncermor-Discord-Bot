...
module.exports = {
    Command: "ping",                  // the command
    Aliases: ["pg"],                  // aliases for the command (alternative commands)
    Description: "Returns pong",      // description of the command
    Value: "",                        // value name if any 
    Slash: {
        CreateCommand: false,         // true if you want to make a / command
        Type: 0,                      // type of value (0 for none)
        Required: false               // if the value is required
    },
